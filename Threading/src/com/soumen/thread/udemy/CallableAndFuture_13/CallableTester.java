package com.soumen.thread.udemy.CallableAndFuture_13;
...
public class CallableTester {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Callable<Integer> callable =() -> { return implement(2);};
    ...
    public static Integer implement(Integer v) {
        for (int i = 0; i < 10; i++) {
            System.out.println("Thread : " + v + " value is : " + i);
        }
        return v;
    }
