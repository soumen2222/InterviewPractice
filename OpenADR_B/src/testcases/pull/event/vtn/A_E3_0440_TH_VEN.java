...
public class A_E3_0440_TH_VEN extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E3_0440_TH_VEN testClass = new A_E3_0440_TH_VEN();
	...
	public void test() throws Exception {
		...
		uiUserPrompt.Prompt(
				resourceFileReader.Prereq_NoEvents_Message()
						+ "\n\n"
						+ resourceFileReader
								.TestCase_0440_Pull_UIUserPromptText(), 1);
