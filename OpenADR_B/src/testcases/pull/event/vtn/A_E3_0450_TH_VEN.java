...
public class A_E3_0450_TH_VEN extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E3_0450_TH_VEN testClass = new A_E3_0450_TH_VEN();
	...
	public void test() throws Exception {
		...
		uiUserPrompt.Prompt(resourceFileReader.Prereq_NoEvents_Message()
				+ "\n\n" + resourceFileReader.TestCase_0450_UIUserPromptText(),
				1);
		...
		if (oadrDistributeEvent.getOadrEvent().size() != 2) {
			...
			LogHelper.addTrace(oadrDistributeEvent.getOadrEvent().size()
					+ " Event(s) were received. Expected 2 Events");
		...
		OadrCreatedEventType oadrCreatedEvent1 = CreatedEventHelper
				.createCreatedEventFromString(oadrCreatedEventStr);
		oadrCreatedEvent1.getEiCreatedEvent().getEventResponses()
				.getEventResponse().get(1).setOptType(OptTypeType.OPT_OUT);

		OadrCreatedEventType oadrCreatedEvent2 = Clone.clone(oadrCreatedEvent1);
		oadrCreatedEvent1.getEiCreatedEvent().getEventResponses()
		...
		String oadrCreatedEventStr1 = SchemaHelper
				.getCreatedEventAsString(oadrCreatedEvent1);
