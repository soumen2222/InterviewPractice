...
public class A_E3_0470_TH_VEN extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E3_0470_TH_VEN testClass = new A_E3_0470_TH_VEN();
	...
	public void test() throws Exception {
		...
		uiUserPrompt.Prompt(resourceFileReader.Prereq_NoEvents_Message()
				+ "\n\n" + resourceFileReader.TestCase_0470_UIUserPromptText(),
				1);
		...
		String message2 = resourceFileReader
				.TestCase_0470_SecondUIUserPromptText();
		...
		pause(5);
		//String response2 = VenToVtnClient.post(distributeEventRes2);

		String distributeEventRes2 = VenToVtnClient.poll(OadrDistributeEventType.class);; 
		
		if(OadrUtil.isValidationErrorPresent()){
			return;
		}

		 isExpectedReceived = OadrUtil.isExpected(distributeEventRes2,OadrDistributeEventType.class);
		...
		OadrDistributeEventType oadrDistributeEvent2 = DistributeEventSignalHelper
				.createOadrDistributeEventFromString(distributeEventRes2);
		...
		distributeEventList2.add(distributeEventRes2);
