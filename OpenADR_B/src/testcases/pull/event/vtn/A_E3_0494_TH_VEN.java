...
public class A_E3_0494_TH_VEN extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E3_0494_TH_VEN testClass = new A_E3_0494_TH_VEN();
	...
	public void test() throws Exception {
		...
		uiUserPrompt.Prompt(resourceFileReader.Prereq_NoEvents_Message()
				+ "\n\n" + resourceFileReader.TestCase_0494_UIUserPromptText(),
				1);
		...
		String message = resourceFileReader.TestCase_0494_SecondUIUserPrompt();
