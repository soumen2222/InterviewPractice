...
public class A_E3_0498_TH_VEN extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E3_0498_TH_VEN testClass = new A_E3_0498_TH_VEN();
	...
	public void test() throws Exception {
		...
		uiUserPrompt.Prompt(resourceFileReader.Prereq_NoEvents_Message()
				+ "\n\n" + resourceFileReader.TestCase_0498_UIUserPromptText(),
				1);
		...
		if(!DistributeEventSignalHelper.isExpectedReceived("C",ResponseRequiredType.NEVER,1, oadrDistributeEvent2.getOadrEvent().get(0))){
			LogHelper.setResult(LogResult.FAIL);
			LogHelper.addTrace("Test Case has Failed");
			return;
		}
