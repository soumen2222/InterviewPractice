...
import com.qualitylogic.openadr.core.action.impl.Pull_CPP_DistributeEventAction_fourEvents;
import com.qualitylogic.openadr.core.base.PULLBaseTestCase;
import com.qualitylogic.openadr.core.oadrpoll.OadrPollQueue;
import com.qualitylogic.openadr.core.vtn.VTNService;

public class A_E3_0510_DUT_VTN_1 extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E3_0510_DUT_VTN_1 testClass = new A_E3_0510_DUT_VTN_1();
	...
	public void test() throws Exception {
		...
		IDistributeEventAction distributeEventAction1 = new Pull_CPP_DistributeEventAction_fourEvents();
