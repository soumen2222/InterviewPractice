...
public class A_E3_0657_DUT_VTN_1 extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E3_0657_DUT_VTN_1 testClass = new A_E3_0657_DUT_VTN_1();
	...
	public void test() throws Exception {
		...
		distributeEventAction2.getDistributeEvent().getOadrEvent().get(0)
		.getEiEvent().getEventDescriptor().setModificationNumber(1);
		...
		OadrPollQueue.addToQueue(distributeEventAction3); 
		...
		responseEventAction1.setlastEvent(true);
