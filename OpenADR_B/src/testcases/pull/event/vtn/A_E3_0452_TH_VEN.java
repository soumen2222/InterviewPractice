...
public class A_E3_0452_TH_VEN extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E3_0452_TH_VEN testClass = new A_E3_0452_TH_VEN();
	...
	public void test() throws Exception {
		...
		uiUserPrompt.Prompt(resourceFileReader.Prereq_NoEvents_Message()
				+ "\n\n" + resourceFileReader.TestCase_0452_UIUserPromptText(),
				1);
		...
		if (TestSession.isUserClickedContinuePlay()) {
			...
			// Create a ArrayList list of distribute event responses for which
			// you need to create created event.
			...
			// Check if there were any errors in the payload and fail test case
			// if found.
			...
			// Test Case condition
			if (DistributeEventSignalHelper.isExpectedReceived("P",ResponseRequiredType.ALWAYS,0, oadrDistributeEvent.getOadrEvent().get(0)) && responseCode.equals("200")) {
