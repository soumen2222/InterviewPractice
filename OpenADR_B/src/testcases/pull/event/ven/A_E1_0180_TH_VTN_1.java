...
import com.qualitylogic.openadr.core.action.impl.E1_0180_DistributeEventAction_1;
import com.qualitylogic.openadr.core.action.impl.E1_0180_DistributeEventAction_2;
...
public class A_E1_0180_TH_VTN_1 extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E1_0180_TH_VTN_1 testClass = new A_E1_0180_TH_VTN_1();
	...
	public void test() throws Exception {
		...
		if (TestSession.isUserClickedContinuePlay()) {
			IDistributeEventAction distributeEventAction1 = new E1_0180_DistributeEventAction_1();
			...
			IDistributeEventAction distributeEventAction2 = new E1_0180_DistributeEventAction_2();
			...
			// Could receive upto 5 CreatedEvent(2 prerequisit + 3 Modified).
			...
			IResponseEventAction responseEventAction5 = new Default_ResponseEventAction();
			ResponseEventActionList
					.addResponseEventAction(responseEventAction5);
			...
			if (!distributeEventAction2.isEventCompleted()) {
				LogHelper.setResult(LogResult.FAIL);
				LogHelper
						.addTrace("Distribute event was not dispatched. Either oadrRequestEvent was not received or the replyLimit in it was less than the 3");
				LogHelper.addTrace("Test Case has Failed");
				return;
			}
