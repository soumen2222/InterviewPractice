...
import com.qualitylogic.openadr.core.action.impl.E1_0230_Pull_DistributeEventAction_OneEvent_TwoInterval_1;
import com.qualitylogic.openadr.core.action.impl.E1_0230_Pull_DistributeEventAction_OneEvent_TwoInterval_2;
...
public class A_E1_0230_TH_VTN_1 extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E1_0230_TH_VTN_1 testClass = new A_E1_0230_TH_VTN_1();
	...
	public void test() throws Exception {
		...
		IDistributeEventAction distributeEventAction1 = new E1_0230_Pull_DistributeEventAction_OneEvent_TwoInterval_1();
		...
		// Setting to true as to handle each created event as a complete step
		// and come out of the pauseForTestCaseTimeout()loop.
		...
		if (!createdEventResult1.isExpectedCreatedEventReceived()) {
			LogHelper.addTrace("No OadrCreatedEventType with " + OptTypeType.OPT_IN
			...
			IDistributeEventAction distributeEventAction2 = new E1_0230_Pull_DistributeEventAction_OneEvent_TwoInterval_2();
			...
			// If validation errors are found stop before 2nd prompt.
			if (atleastOneValidationErrorPresent) {
				LogHelper.setResult(LogResult.FAIL);
				LogHelper.addTrace("Validation Error(s) are present");
				LogHelper.addTrace("Test Case has Failed");
