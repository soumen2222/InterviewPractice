...
public class A_E1_0268_DUT_VEN extends PULLBaseTestCase {

	public static void main(String[] args) throws Exception {
		A_E1_0268_DUT_VEN testClass = new A_E1_0268_DUT_VEN();
	...
	public void test() throws Exception {
		...
		pause(20);
		distributeEventResponse = VenToVtnClient.post(stroadrPollType,VTNServiceType.OadrPoll); 
