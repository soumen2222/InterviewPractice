...
public class A_E1_0092_DUT_VEN extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E1_0092_DUT_VEN testClass = new A_E1_0092_DUT_VEN();
	...
	public void test() throws Exception {
		...
		String distributeEvent1 = VenToVtnClient.poll(OadrDistributeEventType.class);
		
		if(OadrUtil.isValidationErrorPresent()){
			return;
		}

		boolean isExpectedReceived = OadrUtil.isExpected(distributeEvent1,OadrDistributeEventType.class);
