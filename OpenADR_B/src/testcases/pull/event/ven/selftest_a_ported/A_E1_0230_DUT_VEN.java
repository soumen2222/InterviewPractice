...
public class A_E1_0230_DUT_VEN extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E1_0230_DUT_VEN testClass = new A_E1_0230_DUT_VEN();
	...
	public void test() throws Exception {
		...
		uiUserPrompt
				.Prompt("------------Special Instruction------------\n1)This DUT routine has wait time that simulates the user wait action. Please set asyncResponseTimeout=60000 in the properties file.");
