...
public class A_E1_0390_DUT_VEN extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E1_0390_DUT_VEN testClass = new A_E1_0390_DUT_VEN();
	...
	public void test() throws Exception {
		...
		String oadrCreatedEventStr = new CreatedEventErrorAction()
				.getCreateEvent();
