...
import com.qualitylogic.openadr.core.action.impl.E0_0100_DistributeEventAction_2;
...
public class A_E1_0098_TH_VTN_1 extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E1_0098_TH_VTN_1 testClass = new A_E1_0098_TH_VTN_1();
	...
	public void test() throws Exception {
		...
		if (TestSession.isUserClickedContinuePlay()) {
			...
			IDistributeEventAction distributeEventAction2 = new E0_0100_DistributeEventAction_2();
