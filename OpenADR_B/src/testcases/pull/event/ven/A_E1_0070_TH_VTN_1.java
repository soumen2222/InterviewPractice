...
import com.qualitylogic.openadr.core.action.impl.Optional_eiTargetOnly_Pull_CPP_DistributeEventAction;
...
public class A_E1_0070_TH_VTN_1 extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E1_0070_TH_VTN_1 testClass = new A_E1_0070_TH_VTN_1();
	...
	public void test() throws Exception {
		...
		uiUserPrompt.Prompt(resourceFileReader.Prereq_NoEvents_Message()
				+ "\n\n" + resourceFileReader.TestCase_0070_UIUserPromptText(),
				uiUserPrompt.MEDIUM);

		if (TestSession.isUserClickedContinuePlay()) {

			IDistributeEventAction distributeEventAction1 = new Optional_eiTargetOnly_Pull_CPP_DistributeEventAction();
