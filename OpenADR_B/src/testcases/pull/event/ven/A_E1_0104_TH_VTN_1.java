...
import com.qualitylogic.openadr.core.action.impl.E1_0104_DistributeEventAction_2;
...
public class A_E1_0104_TH_VTN_1 extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E1_0104_TH_VTN_1 testClass = new A_E1_0104_TH_VTN_1();
	...
	public void test() throws Exception {
		...
		if (TestSession.isUserClickedContinuePlay()) {
			...
			IDistributeEventAction distributeEventAction2 = new E1_0104_DistributeEventAction_2();
			...
			if (!createdEventResult1.isExpectedCreatedEventReceived()) {
				...
				if (createdEventResult2.isExpectedCreatedEventReceived()) {
					...
					LogHelper
							.addTrace("OadrCreatedEventType received was not expected");
					LogHelper.addTrace("Test Case has Failed");
					LogHelper.setResult(LogResult.FAIL);
				}
			}
