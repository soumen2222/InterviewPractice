...
import com.qualitylogic.openadr.core.action.impl.E1_0096_DistributeEventAction_1;
...
public class A_E1_0096_TH_VTN_1 extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E1_0096_TH_VTN_1 testClass = new A_E1_0096_TH_VTN_1();
	...
	public void test() throws Exception {
		...
		if (TestSession.isUserClickedContinuePlay()) {
			...
			IDistributeEventAction distributeEventAction1 = new E1_0096_DistributeEventAction_1();
			...
			if (createdEventResult1.isExpectedCreatedEventReceived()) {
				...
				LogHelper.addTrace("OadrCreatedEventType was not expected");
