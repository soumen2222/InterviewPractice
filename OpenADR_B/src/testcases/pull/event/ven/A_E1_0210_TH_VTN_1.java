...
public class A_E1_0210_TH_VTN_1 extends PULLBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E1_0210_TH_VTN_1 testClass = new A_E1_0210_TH_VTN_1();
		...
		if (TestSession.isUserClickedContinuePlay()) {
			...
			DistributeEventSignalHelper
					.modificationRuleStartDtCurrentPlusMinutes(eiEvent, eiEvent
							.getEventDescriptor().getCreatedDateTime(), 2);
			...
			if (createdEventResult.isExpectedCreatedEventReceived()) {
				...
				uiUserPrompt2.Prompt(
						resourceFileReader.TestCase_0210_UIUserPromptText(),
						uiUserPrompt.SMALL);
