...
public class R0_8140_TH_VTN extends VtnPushTestCase {

	public static void main(String[] args) {
		execute(new R0_8140_TH_VTN());
	}
	...
	public void test() throws Exception {
		...
		sendCreateReport(CreateReportEventHelper.loadOadrCreateReport_Request_008());
