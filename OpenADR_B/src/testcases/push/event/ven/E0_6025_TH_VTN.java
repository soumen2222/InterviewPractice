...
public class E0_6025_TH_VTN extends VtnPushTestCase {

	public static void main(String[] args) {
		execute(new E0_6025_TH_VTN());
	}
	...
	public void test() throws Exception {
		...
		ICreatedEventResult createdEvent = sendDistributeEvent(new DefaultDistributeEvent_004Action());
