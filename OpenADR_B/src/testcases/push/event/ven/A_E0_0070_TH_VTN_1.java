...
import com.qualitylogic.openadr.core.action.impl.Optional_eiTargetOnly_Push_CPP_DistributeEventAction;
...
public class A_E0_0070_TH_VTN_1 extends PUSHBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E0_0070_TH_VTN_1 testClass = new A_E0_0070_TH_VTN_1();
	...
	public void test() throws Exception {
		...
		if (TestSession.isUserClickedContinuePlay()) {
			...
			IDistributeEventAction distributeEventAction1 = new Optional_eiTargetOnly_Push_CPP_DistributeEventAction();
