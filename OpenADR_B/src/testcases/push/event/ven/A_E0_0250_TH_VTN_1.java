...
import com.qualitylogic.openadr.core.action.impl.E0_0250_DistributeEventAction_1;
import com.qualitylogic.openadr.core.action.impl.E0_0250_DistributeEventAction_2;
...
public class A_E0_0250_TH_VTN_1 extends PUSHBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E0_0250_TH_VTN_1 testClass = new A_E0_0250_TH_VTN_1();
	...
	public void test() throws Exception {
		...
		if (TestSession.isUserClickedContinuePlay()) {
			IDistributeEventAction distributeEventAction1 = new E0_0250_DistributeEventAction_1();
			...
			if (!createdEventResult1.isExpectedCreatedEventReceived()) {
				...
				if (TestSession.isUserClickedContinuePlay()) {
					...
					IDistributeEventAction distributeEventAction2 = new E0_0250_DistributeEventAction_2();
