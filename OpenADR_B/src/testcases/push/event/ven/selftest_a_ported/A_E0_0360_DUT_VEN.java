...
import com.qualitylogic.openadr.core.action.impl.E0_0360CreatedEventAction;
import com.qualitylogic.openadr.core.base.PUSHBaseTestCase;
import com.qualitylogic.openadr.core.util.PropertiesFileReader;
import com.qualitylogic.openadr.core.ven.VENService;

public class A_E0_0360_DUT_VEN  extends PUSHBaseTestCase{

	public static void main(String[] args) {
		try {
			A_E0_0360_DUT_VEN testClass = new A_E0_0360_DUT_VEN();
	...
	public void test() throws Exception {
		...
		ICreatedEventAction createdAction1 = new E0_0360CreatedEventAction(
				false);
