...
public class A_E0_0130_TH_VTN_1 extends PUSHBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E0_0130_TH_VTN_1 testClass = new A_E0_0130_TH_VTN_1();
	...
	public void test() throws Exception {
		...
		String message = resourceFileReader.TestCase_0130_UIUserPromptText();
		message = resourceFileReader.Prereq_NoEvents_Message() + "\n\n"
				+ message;
