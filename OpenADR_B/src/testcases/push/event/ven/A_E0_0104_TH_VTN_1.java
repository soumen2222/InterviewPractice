...
public class A_E0_0104_TH_VTN_1 extends PUSHBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E0_0104_TH_VTN_1 testClass = new A_E0_0104_TH_VTN_1();
	...
	public void test() throws Exception {
		...
		if (TestSession.isUserClickedContinuePlay()) {
			...
			createdEventResult2.setExpectedOptInCount(0);
			...
			if (createdEventResult2.isExpectedCreatedEventReceived()) {
				...
				LogHelper
						.addTrace("OadrCreatedEventType was not received as expected");
