...
public class A_E2_0494_TH_VEN_1 extends PUSHBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E2_0494_TH_VEN_1 testClass = new A_E2_0494_TH_VEN_1();
	...
	public void test() throws Exception {
		...
		String message2 = resourceFileReader.TestCase_0494_SecondUIUserPrompt();
		...
		uiUserPrompt.Prompt(
				resourceFileReader.TestCase_0494_UIUserPromptText(), 1);
