...
public class A_E2_0510_TH_VEN_1 extends PUSHBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E2_0510_TH_VEN_1 testClass = new A_E2_0510_TH_VEN_1();
	...
	public void test() throws Exception {
		...
		new UIUserPrompt().Prompt(
				new ResourceFileReader().TestCase_0510_UIUserPromptText(), 2);
		...
		ICreatedEventAction createdActionToSend = new Default_CreatedEventActionOnLastDistributeEventReceived(
				true, true);
		String createdEventToSend = createdActionToSend.getCreateEvent();
		...
		long modificationNumber1 = -1;
		long modificationNumber2 = -1;
		long modificationNumber3 = -1;
		long modificationNumber4 = -1;


		modificationNumber1 = expectedDistributeEvent.getOadrEvent().get(0)
				.getEiEvent().getEventDescriptor().getModificationNumber();
		modificationNumber2 = expectedDistributeEvent.getOadrEvent().get(1)
				.getEiEvent().getEventDescriptor().getModificationNumber();
		modificationNumber3 = expectedDistributeEvent.getOadrEvent().get(2)
				.getEiEvent().getEventDescriptor().getModificationNumber();
		modificationNumber4 = expectedDistributeEvent.getOadrEvent().get(3)
				.getEiEvent().getEventDescriptor().getModificationNumber();
