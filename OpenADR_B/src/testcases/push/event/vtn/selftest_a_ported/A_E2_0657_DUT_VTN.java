...
public class A_E2_0657_DUT_VTN extends PUSHBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E2_0657_DUT_VTN testClass = new A_E2_0657_DUT_VTN();
	...
	public void test() throws Exception {
		...
		distributeEvent.getOadrEvent().get(0).getEiEvent().getEventDescriptor().setModificationNumber(1);
		...
		// Modified Distribute Event sent again
		distributeEvent.setRequestID(OadrUtil.createoadrDistributeRequestID());
		strOadrDistributeEvent = SchemaHelper
				.getDistributeEventAsString(distributeEvent);
		pause(5);
