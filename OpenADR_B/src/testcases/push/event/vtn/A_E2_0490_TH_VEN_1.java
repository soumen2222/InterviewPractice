...
public class A_E2_0490_TH_VEN_1 extends PUSHBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E2_0490_TH_VEN_1 testClass = new A_E2_0490_TH_VEN_1();
	...
	public void test() throws Exception {
		...
		String message2 = resourceFileReader.TestCase_0490_SecondUIUserPrompt();
		...
		uiUserPrompt.Prompt(
				resourceFileReader.TestCase_0490_UIUserPromptText(), 1);
		...
		if (oadrResponseList.size() == 2) {
			...
			if(!DistributeEventSignalHelper.isExpectedReceived("A",ResponseRequiredType.ALWAYS,0, VENServerResource
			...
			if(!DistributeEventSignalHelper.isExpectedReceived("A",ResponseRequiredType.ALWAYS,1, VENServerResource
