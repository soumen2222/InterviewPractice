...
public class A_E2_0484_TH_VEN_1 extends PUSHBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E2_0484_TH_VEN_1 testClass = new A_E2_0484_TH_VEN_1();
	...
	public void test() throws Exception {
		...
		uiUserPrompt.Prompt(
				resourceFileReader.TestCase_0484_UIUserPromptText(), 1);
