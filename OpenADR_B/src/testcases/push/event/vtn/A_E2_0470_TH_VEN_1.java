...
public class A_E2_0470_TH_VEN_1 extends PUSHBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E2_0470_TH_VEN_1 testClass = new A_E2_0470_TH_VEN_1();
	...
	public void test() throws Exception {
		...
		UIUserPrompt uiUserPrompt2 = new UIUserPrompt(message2, 1);

		createdAction1.setPromptForResponseReceipt(uiUserPrompt2);
		...
		uiUserPrompt.Prompt(
				resourceFileReader.TestCase_0470_UIUserPromptText(), 1);
		...
		LogHelper.addTrace("Start Time :" + new Date());
		pauseForTestCaseTimeout();
		LogHelper.addTrace("End Time :" + new Date());
