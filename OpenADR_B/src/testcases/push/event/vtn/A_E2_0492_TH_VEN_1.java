...
public class A_E2_0492_TH_VEN_1 extends PUSHBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E2_0492_TH_VEN_1 testClass = new A_E2_0492_TH_VEN_1();
	...
	public void test() throws Exception {
		...
		String message2 = resourceFileReader
				.TestCase_0492_Second_UIUserPromptText();
		...
		uiUserPrompt.Prompt(
				resourceFileReader.TestCase_0492_UIUserPromptText(), 1);
