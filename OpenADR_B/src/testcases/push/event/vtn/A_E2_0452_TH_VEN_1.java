...
public class A_E2_0452_TH_VEN_1 extends PUSHBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E2_0452_TH_VEN_1 testClass = new A_E2_0452_TH_VEN_1();
	...
	public void test() throws Exception {
		...
		uiUserPrompt.Prompt(
				resourceFileReader.TestCase_0452_UIUserPromptText(), 1);
		...
		if (TestSession.isUserClickedContinuePlay()) {
			...
			if (oadrResponseList.size() == 1) {
				...
				if (isExpectedResponse && DistributeEventSignalHelper.isExpectedReceived("P",ResponseRequiredType.ALWAYS,0, eiEventList.get(0))) {
