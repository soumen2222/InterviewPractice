...
import com.qualitylogic.openadr.core.action.impl.CreatedEventActionWrongEventIDOnLastDistributeEventReceived;
...
public class A_E2_0720_TH_VEN_1 extends PUSHBaseTestCase {

	public static void main(String[] args) {
		try {
			A_E2_0720_TH_VEN_1 testClass = new A_E2_0720_TH_VEN_1();
	...
	public void test() throws Exception {
		...
		ICreatedEventAction createdAction1 = new CreatedEventActionWrongEventIDOnLastDistributeEventReceived(
				false, true);
		...
		String message = resourceFileReader.TestCase_0720_UIUserPromptText();
		UIUserPrompt uiUserPrompt2 = new UIUserPrompt();
		uiUserPrompt2.Prompt(message, UIUserPrompt.MEDIUM);

		if (!TestSession.isUserClickedContinuePlay()) {
			LogHelper.setResult(LogResult.FAIL);
			LogHelper.addTrace("Test Case has been cancelled by the user");
