...
public class DefaultResponseCreateReportRequest_005Action extends BaseCreateReportAction{
	ServiceType serviceType=null;
	
	public DefaultResponseCreateReportRequest_005Action(ServiceType vtnorven){
	...
	public OadrCreateReportType getOadrCreateReportResponse() {
		...
		try {
			oadrCreateReportType = CreateReportEventHelper.loadOadrCreateReport_Request_005();
