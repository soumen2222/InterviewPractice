...
public class Optional_NoeiTarget_Pull_CPP_DistributeEventAction extends
	...
	public OadrDistributeEventType getDistributeEvent() {
		...
		if (oadrDistributeEvent == null) {
			oadrDistributeEvent = new DistributeEventSignalHelper()
					.loadOadrDistributeEvent("oadrDistributeEvent_Pull_CPP_OptionalElementsExceptTarget.xml");
