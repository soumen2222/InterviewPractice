...
public class Push_CPP_DistributeEventAction_fourEvents extends
	...
	public OadrDistributeEventType getDistributeEvent() {
		...
		if (oadrDistributeEvent == null) {
			oadrDistributeEvent = new DistributeEventSignalHelper()
					.loadOadrDistributeEvent("oadrDistributeEvent_Push_CPP_fourEvents_Default.xml");
			...
			event1.getEventDescriptor().setCreatedDateTime(createdTime);
			// Event 2
