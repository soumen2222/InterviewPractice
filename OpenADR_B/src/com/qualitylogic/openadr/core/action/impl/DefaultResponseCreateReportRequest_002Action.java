...
public class DefaultResponseCreateReportRequest_002Action extends BaseCreateReportAction{
	ServiceType serviceType=null;
	
	public DefaultResponseCreateReportRequest_002Action(ServiceType vtnorven){
	...
	public OadrCreateReportType getOadrCreateReportResponse() {
		...
		try {
			oadrCreateReportType = CreateReportEventHelper.loadOadrCreateReport_Request_002(serviceType);
