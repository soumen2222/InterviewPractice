...
public class DefaultResponseCreateReportRequest_006Action extends BaseCreateReportAction{
	ServiceType serviceType=null;
	
	public DefaultResponseCreateReportRequest_006Action(ServiceType vtnorven){
	...
	public OadrCreateReportType getOadrCreateReportResponse() {
		...
		try {
			oadrCreateReportType = CreateReportEventHelper.loadOadrCreateReport_Request_006();
