...
public class Default_Push_CPP_OptionalElements_DistributeEventAction extends
	...
	public OadrDistributeEventType getDistributeEvent() {
		...
		if (oadrDistributeEvent == null) {
			oadrDistributeEvent = new DistributeEventSignalHelper()
					.loadOadrDistributeEvent("oadrDistributeEvent_Push_CPP_OptionalElementsExceptTarget.xml");
