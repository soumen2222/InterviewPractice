...
public class DefaultResponseCreateReportTypeAckAction extends BaseCreateReportAction{
	ServiceType serviceType=null;
	
	public DefaultResponseCreateReportTypeAckAction(ServiceType vtnorven){
	...
	public OadrCreateReportType getOadrCreateReportResponse() {
		...
		try {
			oadrCreateReportType = CreateReportEventHelper.loadOadrCreateReport(serviceType);
