...
public class DefaultResponseCreateReportRequest_014Action extends BaseCreateReportAction{
	
	public OadrCreateReportType getOadrCreateReportResponse() {

		if(oadrCreateReportType!=null) return oadrCreateReportType;
		try {
			oadrCreateReportType = CreateReportEventHelper.loadOadrCreateReport_Request_014();
