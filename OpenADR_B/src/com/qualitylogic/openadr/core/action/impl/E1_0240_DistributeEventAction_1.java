...
public class E1_0240_DistributeEventAction_1 extends BaseDistributeEventAction {
	...
	public OadrDistributeEventType getDistributeEvent() {
		...
		if (oadrDistributeEvent == null) {
			oadrDistributeEvent = new DistributeEventSignalHelper()
					.loadOadrDistributeEvent("oadrDistributeEvent_Pull_CPP_OneEventTwoInterval.xml");
			...
			// oadrDistributeEvent.getOadrEvent().get(0).getEiEvent().getEventDescriptor().getEiMarketContext().setMarketContext("dfgfdg");
		}
