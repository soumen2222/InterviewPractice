...
// Original code taken from http://www.agentbob.info/agentbob/79-AB.html 
...
public class ImportKey  {
    ...
    public static void main ( String args[]) {
        ...
        // BRD 5/5/2013 added password and keystore parameters
        if (args.length < 2 || args.length>5) {
            System.out.println("Usage: java comu.ImportKey keyfile certfile [alias] [password] [keystore]");
            System.exit(0);
        } else {
            keyfile = args[0];
            certfile = args[1];
