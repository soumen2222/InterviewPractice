...
public class MergingTablesSoumen {
    private final InputReader reader;
    private final OutputWriter writer;

    public MergingTablesSoumen(InputReader reader, OutputWriter writer) {
        this.reader = reader;
        this.writer = writer;
    }
    ...
    public static void main(String[] args) {
        ...
        new MergingTablesSoumen(reader, writer).run();
        writer.writer.flush();
    }
    ...
    void merge(Table destination, Table source) {
		...
		maximumNumberOfRows=Math.max(maximumNumberOfRows, Math.max(realSource.numberOfRows , realDestination.numberOfRows ));
